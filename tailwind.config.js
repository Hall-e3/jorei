...
module.exports = withMT({
  ...
  theme: {
    colors: {
      ...
      grey: "#C2C2CB",
      dark_blue: "#0E122B",
      red_background: "#faefdd",
      success_green: "#33cd77",
      red_colorless_text: "#fc9c7b",
      grey_black_3: "#757679",
      grey_black_2: "#6e6e6e",
      ...
      input_background_white: "#f8f8f8",
      button_grey: "#eeeff2",
      rating_yellow: "#ffdd2b",
      blue: "#3a96ff",
      pink: "#ef4a87",
      oaf_white: "#ffffff",
      success: "#219653",
    ...
    extend: {
      backgroundImage: {
        ...
        background3: "url('/src/assets/jorei/contact.jpg')"
      },
      fontSize: {
        "title-xxl": ["44px", "55px"],
        "title-xl": ["36px", "45px"],
